...
def build_candidate_from_judgement(
    ...
    return PathRecord(
        ...
        proposal_logprob_sum=rollout.proposal_logprob_sum,
        proposal_logprob_mean=rollout.proposal_logprob_mean,
        proposal_distribution=rollout.proposal_distribution,
        g=scored.g,
        n=metrics.n,
        k=metrics.k,
        f=metrics.f,
